...
inline fun <reified V : ViewBinding> ComponentActivity.viewBinding(
    ...
    crossinline viewProvider: (ComponentActivity) -> View = { findRootView(this) }
): ViewBindingProperty<ComponentActivity, V> =
    ActivityViewBindingProperty { viewBinder(viewProvider(it)) }
...
inline fun <reified V : ViewBinding> ComponentActivity.viewBinding(
    ...
    ActivityViewBindingProperty { viewBinder(it.requireViewByIdCompat(viewBindingRootId)) }
...
inline fun <reified F : Fragment, reified V : ViewBinding> Fragment.viewBinding(
    crossinline viewBinder: (View) -> V,
...
inline fun <reified V : ViewBinding> ViewGroup.viewBinding(
    crossinline viewBinder: (View) -> V,
    crossinline viewProvider: (ViewGroup) -> View = { this }
): ViewBindingProperty<ViewGroup, V> =
    LazyViewBindingProperty { viewBinder(viewProvider(it)) }
...
inline fun <reified V : ViewBinding> ViewGroup.viewBinding(
    ...
    LazyViewBindingProperty { viewBinder(it.requireViewByIdCompat(viewBindingRootId)) }
...
inline fun <reified V : ViewBinding> RecyclerView.ViewHolder.viewBinding(
    crossinline viewBinder: (View) -> V,
    crossinline viewProvider: (RecyclerView.ViewHolder) -> View = { it.itemView }
...
inline fun <reified V : ViewBinding> RecyclerView.ViewHolder.viewBinding(
    ...
    LazyViewBindingProperty { viewBinder(it.itemView.requireViewByIdCompat(viewBindingRootId)) }
